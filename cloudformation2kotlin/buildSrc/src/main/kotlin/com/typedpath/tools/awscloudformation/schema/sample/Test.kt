...
import com.typedpath.awscloudformation.iamPolicy
import com.typedpath.awscloudformation.schema.sample.aWS_IAM_Policy
...
fun main(args: Array<String>) {
  ...
  val policyName = """aaa${SimpleDateFormat("yyMMdd_HHmmss").format(Date())}"""

  val policy = aWS_IAM_Policy(iamPolicy, policyName) {
